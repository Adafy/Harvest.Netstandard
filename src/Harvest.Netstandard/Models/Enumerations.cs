...
namespace Adafy.Harvest.Netstandard.Models
{
    public enum Currency
    {
        ...
        [Description("South Africa Rand - ZAR")]
        ZAR,

        [Description("Afghanistan Afghani - AFN")]
        AFN,
        ...
        [Description("Chile Unidad de Fomento - CLF")]
        CLF,
        ...
        [Description("Costa Rica Colon - CRC")]
        CRC,
        [Description("Croatia Kuna - HRK")] HRK,
        [Description("Cyprus Pound - CYP")] CYP,

        [Description("Czech Republic Koruny - CZK")]
        CZK,

        [Description("Dominican Republic Peso - DOP")]
        DOP,

        [Description("Eastern Caribbean Dollar - XCD")]
        XCD,
        ...
        [Description("Lithuanian Litas - LTL")]
        LTL,
        [Description("Macanese Pataca - MOP")] MOP,

        [Description("Macdeonian Denar - MKD")]
        MKD,

        [Description("Malaysia Ringgit - MYR")]
        MYR,
        ...
        [Description("Papua New Guinea Kina - PGK")]
        PGK,

        [Description("Paraguayan Guarani - PYG")]
        PYG,

        [Description("Peru Nuevos Soles - PEN")]
        PEN,

        [Description("Philippines Peso - PHP")]
        PHP,
        ...
        [Description("Saudi Arabia Riyal - SAR")]
        SAR,
        [Description("Serbia Dinar - RSD")] RSD,

        [Description("Seychelles Rupee - SCR")]
        SCR,
        ...
        [Description("Taiwan New Dollar - TWD")]
        TWD,
        ...
        [Description("Venezuela Bolivares - VEB")]
        VEB,

        [Description("Venezuela Bolivares Fuertes - VEF")]
        VEF,
    ...
    public enum InvoiceDateAtFormat
    {
        ...
        /// </summary>
        [Description("upon receipt")] UponReceipt,

        /// <summary>
        /// 15 days until the invoice is due.
        /// </summary>
        [Description("net 15")] Net15,

        /// <summary>
        /// 30 days until the invoice is due.
        /// </summary>
        [Description("net 30")] Net30,

        /// <summary>
        /// 45 days until the invoice is due.
        /// </summary>
        [Description("net 45")] Net45,

        /// <summary>
        /// 60 days until the invoice is due.
        /// </summary>
        [Description("net 60")] Net60,
    ...
    public enum BudgetMethod
    {
        ...
        /// </summary>
        [Description("project_cost")] ProjectCost,
        ...
        /// </summary>
        [Description("task_fees")] TaskFees
    }
