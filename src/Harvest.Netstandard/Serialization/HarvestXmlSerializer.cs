...
namespace Adafy.Harvest.Netstandard.Serialization
{
    public class HarvestXmlSerializer : ISerializer
    {
        ...
        {
            get => _defaultSerializer.ContentType;

            set => _defaultSerializer.ContentType = value;
        }

        public string DateFormat
        {
            get => _defaultSerializer.DateFormat;

            set => _defaultSerializer.DateFormat = value;
        }

        public string Namespace
        {
            get => _defaultSerializer.Namespace;

            set => _defaultSerializer.Namespace = value;
        }

        public string RootElement
        {
            get => _defaultSerializer.RootElement;

            set => _defaultSerializer.RootElement = value;
        }
