...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public bool DeleteClient(long clientId)
        {
            ...
            return Extensions.IsSuccessfulDelete(result);
        }
        ...
        public Client UpdateClient(long clientId, string name = null, Currency? currency = null, bool? active = null, string details = null,
