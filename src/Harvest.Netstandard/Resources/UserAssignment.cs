...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public UserAssignment UpdateUserAssignment(long projectId, long userAssignmentId, long userId, bool? deactivated = null, decimal? hourlyRate = null,
            decimal? budget = null, bool? isProjectManager = null)
        {
        ...
        /// <param name="budget">The budget</param>
        /// <param name="isProjectManager">Whether this user is a project manager</param>
        public Task<UserAssignment> UpdateUserAssignmentAsync(long projectId, long userAssignmentId, long userId, bool? deactivated = null,
            decimal? hourlyRate = null, decimal? budget = null, bool? isProjectManager = null)
        {
            var options = GetUpdateUserAssignmentOptions(projectId, userId, deactivated, hourlyRate, budget, isProjectManager);
        ...
        private IRestRequest CreateUserAssignmentRequest(long projectId, long userId)
        {
            ...
            request.AddBody(new UserAssignmentCreateOptions() { Id = userId });

            return request;
        }

        private static UserAssignmentOptions GetUpdateUserAssignmentOptions(long projectId, long userId, bool? deactivated, decimal? hourlyRate,
            decimal? budget, bool? isProjectManager)
        {
