...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        {
            var request = DailyRequest(dayOfTheYear, year, ofUser);
        ...
        /// <param name="year">The year to list. If null, lists today.</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public Task<Daily> DailyAsync(short? dayOfTheYear = null, short? year = null, long? ofUser = null)
        {
            var request = DailyRequest(dayOfTheYear, year, ofUser);

            return ExecuteAsync<Daily>(request);
        }
        ...
        {
            var request = DailyRequest(dayEntryId, ofUser);
        ...
        /// <param name="dayEntryId">The ID of the day entry to retrieve</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public Task<Timer> DailyAsync(long dayEntryId, long? ofUser = null)
        {
            var request = DailyRequest(dayEntryId, ofUser);
        ...
        {
            var request = ToggleDailyRequest(dayEntryId, ofUser);
        ...
        /// <param name="dayEntryId">The ID of the day entry to retrieve</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public Task<Timer> ToggleDailyAsync(long dayEntryId, long? ofUser = null)
        {
            var request = ToggleDailyRequest(dayEntryId, ofUser);
        ...
        {
            var options = GetCreateDailyOptions(spentAt, projectId, taskId, hours, notes);
        ...
        /// <param name="notes">The notes on the entry</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public Task<Timer> CreateDailyAsync(DateTime spentAt, long projectId, long taskId, decimal hours, string notes = null, long? ofUser = null)
        {
            var options = GetCreateDailyOptions(spentAt, projectId, taskId, hours, notes);

            return CreateDailyAsync(options, ofUser);
        }
        ...
        {
            var options = GetCreateDailyOptions(spentAt, projectId, taskId, startedAt, endedAt, notes);
        ...
        /// <param name="notes">The notes on the entry</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public Task<Timer> CreateDailyAsync(DateTime spentAt, long projectId, long taskId, TimeSpan startedAt, TimeSpan endedAt, string notes = null,
            long? ofUser = null)
        {
            var options = GetCreateDailyOptions(spentAt, projectId, taskId, startedAt, endedAt, notes);
        ...
        {
            var options = GetStartTimerOptions(spentAt, projectId, taskId, notes);
        ...
        /// <param name="notes">The notes on the entry</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public Task<Timer> StartTimerAsync(DateTime spentAt, long projectId, long taskId, string notes = null, long? ofUser = null)
        {
            var options = GetStartTimerOptions(spentAt, projectId, taskId, notes);
        ...
        {
            var request = DeleteDailyRequest(dayEntryId, ofUser);
        ...
        /// <param name="dayEntryId">The ID of the day entry to delete</param>
        /// <param name="ofUser">The user the day entry belongs to</param>
        public async Task<bool> DeleteDailyAsync(long dayEntryId, long? ofUser = null)
        {
            var request = DeleteDailyRequest(dayEntryId, ofUser);
        ...
        public Timer UpdateDaily(long dayEntryId, DateTime? spentAt = null, long? projectId = null, long? taskId = null, decimal? hours = null,
            TimeSpan? startedAt = null, TimeSpan? endedAt = null, string notes = null, long? ofUser = null)
        {
            var options = GetUpdateDailyOptions(spentAt, projectId, taskId, hours, startedAt, endedAt, notes);
        ...
        /// <param name="notes">The new notes for the entry</param>
        /// <param name="ofUser">The user the entry belongs to</param>
        public Task<Timer> UpdateDailyAsync(long dayEntryId, DateTime? spentAt = null, long? projectId = null, long? taskId = null, decimal? hours = null,
            TimeSpan? startedAt = null, TimeSpan? endedAt = null, string notes = null, long? ofUser = null)
        {
            var options = GetUpdateDailyOptions(spentAt, projectId, taskId, hours, startedAt, endedAt, notes);

            return UpdateDailyAsync(dayEntryId, options, ofUser);
        }
        ...
        private IRestRequest DailyRequest(short? dayOfTheYear, short? year, long? ofUser)
        {
        ...
        private IRestRequest DailyRequest(long dayEntryId, long? ofUser)
        {
        ...
        private IRestRequest ToggleDailyRequest(long dayEntryId, long? ofUser)
        {
        ...
        private static DailyOptions GetCreateDailyOptions(DateTime spentAt, long projectId, long taskId, decimal hours, string notes)
        {
        ...
        private static DailyOptions GetCreateDailyOptions(DateTime spentAt, long projectId, long taskId, TimeSpan startedAt, TimeSpan endedAt, string notes)
        {
            return new DailyOptions
            {
                Notes = notes,
        ...
        private static DailyOptions GetStartTimerOptions(DateTime spentAt, long projectId, long taskId, string notes)
        {
            return new DailyOptions
            {
                Notes = notes,
        ...
        private IRestRequest DeleteDailyRequest(long dayEntryId, long? ofUser)
        {
            var request = Request("daily/delete/" + dayEntryId, Method.DELETE);
        ...
        private static DailyOptions GetUpdateDailyOptions(DateTime? spentAt, long? projectId, long? taskId, decimal? hours, TimeSpan? startedAt,
            TimeSpan? endedAt, string notes)
        {
            var options = new DailyOptions { SpentAt = spentAt, ProjectId = projectId, TaskId = taskId, Notes = notes };
