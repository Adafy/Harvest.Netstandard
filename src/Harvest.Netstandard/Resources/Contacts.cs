...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public Contact CreateContact(long clientId, string firstName, string lastName, string title = null, string email = null, string phoneOffice = null,
            string phoneMobile = null, string fax = null)
        {
        ...
        /// <param name="phoneMobile">The contact's mobile phone number</param>
        /// <param name="fax">The contact's fax number</param>
        public Task<Contact> CreateContactAsync(long clientId, string firstName, string lastName, string title = null, string email = null,
            string phoneOffice = null, string phoneMobile = null, string fax = null)
        {
            if (firstName == null)
            {
        ...
        /// <param name="phoneMobile">The contact's mobile phone number</param>
        /// <param name="fax">The contact's fax number</param>
        public Contact UpdateContact(long contactId, long? clientId = null, string firstName = null, string lastName = null, string title = null,
        ...
        /// <param name="phoneMobile">The contact's mobile phone number</param>
        /// <param name="fax">The contact's fax number</param>
        public Task<Contact> UpdateContactAsync(long contactId, long? clientId = null, string firstName = null, string lastName = null, string title = null,
            string email = null, string phoneOffice = null, string phoneMobile = null, string fax = null)
        {
            var options = GetContactOptions(clientId, firstName, lastName, title, email, phoneOffice, phoneMobile, fax);
        ...
        private static ContactOptions GetContactOptions(long? clientId, string firstName, string lastName, string title, string email, string phoneOffice,
            string phoneMobile, string fax)
        {
        ...
        {
            return ListRequest($"{CLIENTS_RESOURCE}/{clientId}/{CONTACTS_RESOURCE}", updatedSince);
        }
    }
}
