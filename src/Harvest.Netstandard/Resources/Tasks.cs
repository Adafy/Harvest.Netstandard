...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        /// <param name="isDefault">Whether the task should be added to new projects</param>
        /// <param name="defaultHourlyRate">The default hourly rate</param>
        public Models.Task UpdateTask(long taskId, string name = null, bool? billableByDefault = null, bool? isDefault = null,
        ...
        /// <param name="isDefault">Whether the task should be added to new projects</param>
        /// <param name="defaultHourlyRate">The default hourly rate</param>
        public Task<Models.Task> UpdateTaskAsync(long taskId, string name = null, bool? billableByDefault = null, bool? isDefault = null,
            decimal? defaultHourlyRate = null)
        {
            var options = GetTaskOptions(name, billableByDefault, isDefault, defaultHourlyRate);
        ...
        {
            var options = new TaskOptions { Name = name, BillableByDefault = billableByDefault, IsDefault = isDefault, DefaultHourlyRate = defaultHourlyRate };
