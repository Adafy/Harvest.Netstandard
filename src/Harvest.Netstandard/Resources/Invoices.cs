...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public IList<Invoice> ListInvoices(int page = 1, DateTime? from = null, DateTime? to = null, DateTime? updatedSince = null, InvoiceState? status = null,
            long? clientId = null)
        {
        ...
        /// <param name="status">The status of invoices to retrieve</param>
        /// <param name="clientId">The client ID of invoices to retrieve</param>
        public async Task<IList<Invoice>> ListInvoicesAsync(int page = 1, DateTime? from = null, DateTime? to = null, DateTime? updatedSince = null,
            InvoiceState? status = null, long? clientId = null)
        {
            var request = ListInvoicesRequest(page, from, to, updatedSince, status, clientId);

            // ReSharper disable once AsyncConverter.AsyncAwaitMayBeElidedHighlighting
            return await ExecuteAsync<List<Invoice>>(request).ConfigureAwait(false);
        }
        ...
        public Invoice CreateInvoice(InvoiceKind kind, long clientId, DateTime issuedAt,
            DateTime? dueAt = null, Currency? currency = null, string subject = null, string notes = null, string number = null, long[] projectIds = null,
            List<InvoiceItem> lineItems = null)
        {
        ...
        private static InvoiceOptions GetInvoiceOptions(InvoiceKind kind, long clientId, DateTime issuedAt, DateTime? dueAt, Currency? currency, string subject,
            string notes, string number, long[] projectIds, List<InvoiceItem> lineItems)
        {
