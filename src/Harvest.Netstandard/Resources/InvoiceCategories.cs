...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        /// <param name="useAsExpense">Whether to use as expense</param>
        /// <param name="useAsService">Whether to use as service</param>
        public Task<InvoiceItemCategory> UpdateInvoiceCategoryAsync(long invoiceCategoryId, string name = null, bool? useAsExpense = null,
        ...
        {
            return new InvoiceItemCategoryOptions { Name = name, UseAsExpense = useAsExpense, UseAsService = useAsService };
        }
    }
}
