...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public Expense CreateExpense(DateTime spentAt, long projectId, long expenseCategoryId, decimal? totalCost = null, decimal? units = null,
            string notes = null, bool isBillable = true, long? ofUser = null)
        {
        ...
        /// <param name="notes">The notes on the expense</param>
        /// <param name="isBillable">Whether the expense is billable</param>
        public Task<Expense> CreateExpenseAsync(DateTime spentAt, long projectId, long expenseCategoryId, decimal? totalCost = null, decimal? units = null,
            string notes = null, bool isBillable = true, long? ofUser = null)
        {
            var options = GetExpenseOptions(spentAt, projectId, expenseCategoryId, totalCost, units, notes, isBillable);
        ...
        public Expense UpdateExpense(long expenseId, DateTime? spentAt = null, long? projectId = null, long? expenseCategoryId = null,
            decimal? totalCost = null, decimal? units = null, string notes = null, bool? isBillable = null, long? ofUser = null)
        {
            var options = GetExpenseOptions(spentAt, projectId, expenseCategoryId, totalCost, units, notes, isBillable);
        ...
        /// <param name="notes">The new notes of the expense</param>
        /// <param name="isBillable">The new billable status of the expense</param>
        public Task<Expense> UpdateExpenseAsync(long expenseId, DateTime? spentAt = null, long? projectId = null, long? expenseCategoryId = null,
            decimal? totalCost = null, decimal? units = null, string notes = null, bool? isBillable = null, long? ofUser = null)
        {
            var options = GetExpenseOptions(spentAt, projectId, expenseCategoryId, totalCost, units, notes, isBillable);
        ...
        private IRestRequest AttachExpenseReceiptRequest(long expenseId, byte[] bytes, string fileName, long? ofUser)
        {
            ...
            if (!ALLOWED_RECEIPT_FILE_TYPES.ContainsKey(extension))
            {
                throw new ArgumentOutOfRangeException(nameof(fileName),
                    "Receipt Allowed file types: " + string.Join(", ", ALLOWED_RECEIPT_FILE_TYPES.Values.ToArray()));
            }
        ...
        private static ExpenseOptions GetExpenseOptions(DateTime? spentAt, long? projectId, long? expenseCategoryId, decimal? totalCost, decimal? units,
            string notes, bool? isBillable)
        {
