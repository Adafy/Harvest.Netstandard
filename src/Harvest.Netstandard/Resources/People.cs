...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public User CreateUser(string email, string firstName, string lastName, bool isActive = true, string timezone = null, bool? isAdmin = null,
            string telephone = null, string department = null, bool? isContractor = null, bool? hasAccessToAllFutureProjects = null,
            bool? wantsNewsletter = null, bool? wantsWeeklyDigest = null, decimal? defaultHourlyRate = null, decimal? costRate = null)
        {
            var options = GetCreateUserOptions(email, firstName, lastName, isActive, timezone, isAdmin, telephone, department, isContractor,
                hasAccessToAllFutureProjects, wantsNewsletter, wantsWeeklyDigest, defaultHourlyRate, costRate);
        ...
        public User UpdateUser(long userId, string email = null, string firstName = null, string lastName = null, string timezone = null, bool? isAdmin = null,
            ...
            bool? wantsNewsletter = null, bool? wantsWeeklyDigest = null, decimal? defaultHourlyRate = null, decimal? costRate = null)
        {
            var options = GetUpdateUserOptions(email, firstName, lastName, timezone, isAdmin, telephone, department, isContractor, hasAccessToAllFutureProjects,
                wantsNewsletter, wantsWeeklyDigest, defaultHourlyRate, costRate);
        ...
        /// <param name="defaultHourlyRate">The user's default hourly rate</param>
        /// <param name="costRate">The user's cost rate</param>
        public Task<User> UpdateUserAsync(long userId, string email = null, string firstName = null, string lastName = null, string timezone = null,
            bool? isAdmin = null, string telephone = null, string department = null, bool? isContractor = null, bool? hasAccessToAllFutureProjects = null,
            bool? wantsNewsletter = null, bool? wantsWeeklyDigest = null, decimal? defaultHourlyRate = null, decimal? costRate = null)
        {
            var options = GetUpdateUserOptions(email, firstName, lastName, timezone, isAdmin, telephone, department, isContractor, hasAccessToAllFutureProjects,
                wantsNewsletter, wantsWeeklyDigest, defaultHourlyRate, costRate);
        ...
        private static UserOptions GetUpdateUserOptions(string email, string firstName, string lastName, string timezone, bool? isAdmin, string telephone,
            string department, bool? isContractor, bool? hasAccessToAllFutureProjects, bool? wantsNewsletter, bool? wantsWeeklyDigest,
            decimal? defaultHourlyRate, decimal? costRate)
        {
        ...
        private static UserOptions GetCreateUserOptions(string email, string firstName, string lastName, bool isActive, string timezone, bool? isAdmin,
            string telephone, string department, bool? isContractor, bool? hasAccessToAllFutureProjects, bool? wantsNewsletter, bool? wantsWeeklyDigest,
            decimal? defaultHourlyRate, decimal? costRate)
        {
            if (email == null)
            {
