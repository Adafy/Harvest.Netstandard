...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        /// <param name="budgetBy">The budgeting method for the project</param>
        /// <param name="budget">The budget of the project</param>
        public Task<Project> CreateProjectAsync(string name, long clientId, bool active = true, BillingMethod billBy = BillingMethod.None, string code = null,
            string notes = null, BudgetMethod budgetBy = BudgetMethod.None, decimal? budget = null)
        {
            var options = GetCreateProjectOptions(name, clientId, active, billBy, code, notes, budgetBy, budget);
        ...
        public Project UpdateProject(long projectId, long clientId, string name = null, bool? billable = null, BillingMethod? billBy = null, string code = null,
            string notes = null, BudgetMethod? budgetBy = null, decimal? budget = null, bool? notifyWhenOverBudget = null,
            decimal? overBudgetNotificationPercentage = null, bool? showBudgetToAll = null, EstimateMethod? estimateBy = null, decimal? estimate = null,
            decimal? hourlyRate = null, decimal? costBudget = null, bool? costBudgetIncludeExpenses = null)
        {
            var options = GetUpdateProjectOptions(clientId, name, billable, billBy, code, notes, budgetBy, budget, notifyWhenOverBudget,
                overBudgetNotificationPercentage, showBudgetToAll, estimateBy, estimate, hourlyRate, costBudget, costBudgetIncludeExpenses);
        ...
        /// <param name="costBudget">The project cost budget</param>
        /// <param name="costBudgetIncludeExpenses">Whether the cost budget includes expenses</param>
        public Task<Project> UpdateProjectAsync(long projectId, long clientId, string name = null, bool? billable = null, BillingMethod? billBy = null,
            string code = null, string notes = null, BudgetMethod? budgetBy = null, decimal? budget = null, bool? notifyWhenOverBudget = null,
            decimal? overBudgetNotificationPercentage = null, bool? showBudgetToAll = null, EstimateMethod? estimateBy = null, decimal? estimate = null,
            decimal? hourlyRate = null, decimal? costBudget = null, bool? costBudgetIncludeExpenses = null)
        {
            var options = GetUpdateProjectOptions(clientId, name, billable, billBy, code, notes, budgetBy, budget, notifyWhenOverBudget,
        ...
        private static ProjectOptions GetCreateProjectOptions(string name, long clientId, bool active, BillingMethod billBy, string code, string notes,
            BudgetMethod budgetBy, decimal? budget)
        {
            if (name == null)
            {
        ...
        private static ProjectOptions GetUpdateProjectOptions(long clientId, string name, bool? billable, BillingMethod? billBy, string code, string notes,
            BudgetMethod? budgetBy, decimal? budget, bool? notifyWhenOverBudget, decimal? overBudgetNotificationPercentage, bool? showBudgetToAll,
            EstimateMethod? estimateBy, decimal? estimate, decimal? hourlyRate, decimal? costBudget, bool? costBudgetIncludeExpenses)
        {
