...
namespace Adafy.Harvest.Netstandard
{
    public partial class HarvestRestClient
    {
        ...
        public TaskAssignment UpdateTaskAssignment(long projectId, long taskAssignmentId, bool? billable = null, bool? deactivated = null,
            decimal? hourlyRate = null, decimal? budget = null)
        {
        ...
        /// <param name="hourlyRate">The hourly rate</param>
        /// <param name="budget">The budget</param>
        public Task<TaskAssignment> UpdateTaskAssignmentAsync(long projectId, long taskAssignmentId, bool? billable = null, bool? deactivated = null,
            decimal? hourlyRate = null, decimal? budget = null)
        {
            var options = GetUpdateTaskAssignmentOptions(billable, deactivated, hourlyRate, budget);
        ...
        private IRestRequest CreateTaskAssignmentRequest(long projectId, long taskId)
        {
            ...
            request.AddBody(new TaskAssignmentCreateOptions { Id = taskId });
        ...
        private IRestRequest CreateNewTaskAndAssignRequest(long projectId, string name)
        {
            ...
            request.AddBody(new TaskOptions { Name = name });
        ...
        {
            return new TaskAssignmentOptions { Billable = billable, Deactivated = deactivated, HourlyRate = hourlyRate, Budget = budget };
        }
    }
}
