...
using Adafy.Harvest.Netstandard.Network;
using Adafy.Harvest.Netstandard.Serialization;
using Adafy.Harvest.Netstandard.Utilities;
using RestSharp;
    ...
    public partial class HarvestRestClient : IHarvestRestClient
    {
        ...
        protected IRestRequest Request(string resource, Method method = Method.GET)
        {
            var request = new RestRequest
            {
                ...
                XmlSerializer = new HarvestXmlSerializer { DateFormat = DateFormat },
        ...
        private static bool ShouldRequestLocationData<T>(IRestRequest request, IRestResponse<T> response)
        {
            return response.Data == null
                   && (response.StatusCode == HttpStatusCode.Created
                       ...
                       || response.StatusCode == HttpStatusCode.OK && (request.Method == Method.PUT || request.Method == Method.POST));
        }
        ...
        {
            var r = new RestRequest { Method = Method.POST, Resource = "oauth2/token" };
        ...
        private static readonly IDictionary<string, object> Dependencies =
